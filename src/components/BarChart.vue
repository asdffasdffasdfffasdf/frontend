...
export default {
  ...
  beforeMount() {
    ...
    this.options2 = chartConfig.options;
    this.lineChartData = chartConfig.data;
    this.lineChartData2 = chartConfig.data2;
    this.lineChartData3 = chartConfig.data3;
    this.lineChartData4 = chartConfig.data4;
